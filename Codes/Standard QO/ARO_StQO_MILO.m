...
options = sdpsettings('verbose',1, 'solver', 'gurobi','warmstart',1,'gurobi.TimeLimit',max([3000-T1-T0,1]),'savesolveroutput',1);  % Using Gurobi solver; change as needed
...
% Output display
fprintf('Best Scenario: %s\n', mat2str(UB));
fprintf('Time Scenario: %s\n', mat2str(Time_sena));
%%
